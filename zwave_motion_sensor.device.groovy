...
metadata {
	definition (name: "My Z-Wave Motion Sensor", namespace: "jscgs350", author: "SmartThings") {
...
def parse(String description) {
    ...
    if (inactivityTimeout) {
		log.debug "Applying timeout value for Z-Wave Motion Sensor: ${inactivityTimeout}"
