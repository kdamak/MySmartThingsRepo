...
metadata {
    definition (name: "My Irrigation Controller 8 Zones v2.67", version: "2.67", author: "stan@dotson.info", namespace: "BD0G") {
...
//  Comment out the 3 lines below, and remove the comment boundaries from the section above to put Zone 8 back to it's inntended purpose for a sprinkler
        standardTile("zoneEightTile", "device.zoneEight", width: 1, height: 1, canChangeIcon: true, canChangeBackground: true) {
            state "actuate", label: 'Actuate', action: "actuateOpener", icon: "st.doors.garage.garage-closed", backgroundColor: "#53a7c0"
        }
